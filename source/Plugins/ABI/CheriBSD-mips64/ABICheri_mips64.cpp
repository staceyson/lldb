...
g_register_infos_mips64[] =
{
  ...
  //  ========  ======  == === =============  =================== ============ ===================== ==================== =================     ====================== ========== ===============
    ...
    { "ic"    , NULL,   8,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_ic,      gcc_dwarf_ic,           LLDB_INVALID_REGNUM,        gdb_ic,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "synpc" , NULL,   8,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_synpc,   gcc_dwarf_synpc,        LLDB_INVALID_REGNUM,        gdb_synpc,  LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c0"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c0,      gcc_dwarf_c0,           LLDB_INVALID_REGNUM,        gdb_c0,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c1"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c1,      gcc_dwarf_c0,           LLDB_INVALID_REGNUM,        gdb_c1,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c2"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c2,      gcc_dwarf_c2,           LLDB_INVALID_REGNUM,        gdb_c2,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c3"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c3,      gcc_dwarf_c3,           LLDB_INVALID_REGNUM,        gdb_c3,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c4"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c4,      gcc_dwarf_c4,           LLDB_INVALID_REGNUM,        gdb_c4,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c5"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c5,      gcc_dwarf_c5,           LLDB_INVALID_REGNUM,        gdb_c5,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c6"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c6,      gcc_dwarf_c6,           LLDB_INVALID_REGNUM,        gdb_c6,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c7"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c7,      gcc_dwarf_c7,           LLDB_INVALID_REGNUM,        gdb_c7,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c8"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c8,      gcc_dwarf_c8,           LLDB_INVALID_REGNUM,        gdb_c8,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c9"    , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c9,      gcc_dwarf_c9,           LLDB_INVALID_REGNUM,        gdb_c9,     LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c10"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c10,     gcc_dwarf_c10,          LLDB_INVALID_REGNUM,        gdb_c10,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c11"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c11,     gcc_dwarf_c11,          LLDB_INVALID_REGNUM,        gdb_c11,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c12"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c12,     gcc_dwarf_c12,          LLDB_INVALID_REGNUM,        gdb_c12,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c13"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c13,     gcc_dwarf_c13,          LLDB_INVALID_REGNUM,        gdb_c13,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c14"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c14,     gcc_dwarf_c14,          LLDB_INVALID_REGNUM,        gdb_c14,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c15"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c15,     gcc_dwarf_c15,          LLDB_INVALID_REGNUM,        gdb_c15,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c16"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c16,     gcc_dwarf_c16,          LLDB_INVALID_REGNUM,        gdb_c16,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c17"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c17,     gcc_dwarf_c17,          LLDB_INVALID_REGNUM,        gdb_c17,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c18"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c18,     gcc_dwarf_c18,          LLDB_INVALID_REGNUM,        gdb_c18,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c19"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c19,     gcc_dwarf_c19,          LLDB_INVALID_REGNUM,        gdb_c19,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c20"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c20,     gcc_dwarf_c20,          LLDB_INVALID_REGNUM,        gdb_c20,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c21"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c21,     gcc_dwarf_c21,          LLDB_INVALID_REGNUM,        gdb_c21,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c22"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c22,     gcc_dwarf_c22,          LLDB_INVALID_REGNUM,        gdb_c22,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c23"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c23,     gcc_dwarf_c23,          LLDB_INVALID_REGNUM,        gdb_c23,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c24"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c24,     gcc_dwarf_c24,          LLDB_INVALID_REGNUM,        gdb_c24,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c25"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c25,     gcc_dwarf_c25,          LLDB_INVALID_REGNUM,        gdb_c25,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c26"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c26,     gcc_dwarf_c26,          LLDB_INVALID_REGNUM,        gdb_c26,    LLDB_INVALID_REGNUM },  NULL,      NULL},
    { "c27"   , NULL,  32,  0, eEncodingUint, eFormatHex,  { gcc_dwarf_c27,     gcc_dwarf_c27,          LLDB_INVALID_REGNUM,        gdb_c27,    LLDB_INVALID_REGNUM },  NULL,      NULL},
};

static const uint32_t k_num_register_infos = llvm::array_lengthof(g_register_infos_mips64);

const lldb_private::RegisterInfo *
ABICheri_mips64::GetRegisterInfoArray (uint32_t &count)
{
...
size_t
ABICheri_mips64::GetRedZoneSize () const
{
    return 0;
}
...
//------------------------------------------------------------------
ABISP
ABICheri_mips64::CreateInstance (const ArchSpec &arch)
{
    static ABISP g_abi_sp;
    const llvm::Triple::ArchType arch_type = arch.GetTriple().getArch();
    if (arch_type == llvm::Triple::cheri)
    {
        if (!g_abi_sp)
            g_abi_sp.reset (new ABICheri_mips64);
        return g_abi_sp;
    }
    return ABISP();
}
...
bool
ABICheri_mips64::PrepareTrivialCall (Thread &thread,
                                  addr_t sp,
                                  addr_t func_addr,
                                  addr_t return_addr,
                                  llvm::ArrayRef<addr_t> args) const
{
    ...
    {
        StreamString s;
        s.Printf("ABICheri_mips64::PrepareTrivialCall (tid = 0x%" PRIx64 ", sp = 0x%" PRIx64 ", func_addr = 0x%" PRIx64 ", return_addr = 0x%" PRIx64,
                    thread.GetID(),
                    (uint64_t)sp,
                    (uint64_t)func_addr,
...
bool
ABICheri_mips64::GetArgumentValues (Thread &thread, ValueList &values) const
{
    return false;
}

Error
ABICheri_mips64::SetReturnValueObject(lldb::StackFrameSP &frame_sp, lldb::ValueObjectSP &new_value_sp)
{
    Error error;
    if (!new_value_sp)
    {
...
ValueObjectSP
ABICheri_mips64::GetReturnValueObjectSimple (Thread &thread, CompilerType &return_clang_type) const
{
...
ValueObjectSP
ABICheri_mips64::GetReturnValueObjectImpl (Thread &thread, CompilerType &return_clang_type) const
{
    ValueObjectSP return_valobj_sp;
    Value value;
    Error error;
...
bool
ABICheri_mips64::CreateFunctionEntryUnwindPlan (UnwindPlan &unwind_plan)
{
    unwind_plan.Clear();
    ...
    unwind_plan.SetSourceName ("cheri-mips64 at-func-entry default");
...
bool
ABICheri_mips64::CreateDefaultUnwindPlan (UnwindPlan &unwind_plan)
{
    unwind_plan.Clear();
    unwind_plan.SetRegisterKind (eRegisterKindDWARF);
    ...
    unwind_plan.AppendRow (row);
    unwind_plan.SetSourceName ("cheri-mips64 default unwind plan");
    unwind_plan.SetSourcedFromCompiler (eLazyBoolNo);
...
bool
ABICheri_mips64::RegisterIsVolatile (const RegisterInfo *reg_info)
{
    return !RegisterIsCalleeSaved (reg_info);
}

bool
ABICheri_mips64::RegisterIsCalleeSaved (const RegisterInfo *reg_info)
{
    if (reg_info)
    {
...
ABICheri_mips64::Initialize()
{
    PluginManager::RegisterPlugin (GetPluginNameStatic(),
                                   "CheriABI for Cheri(mips64) targets",
                                   CreateInstance);
}

void
ABICheri_mips64::Terminate()
{
    PluginManager::UnregisterPlugin (CreateInstance);
}

lldb_private::ConstString
ABICheri_mips64::GetPluginNameStatic()
{
    static ConstString g_name("cheribsd-mips64");
    return g_name;
}
...
//------------------------------------------------------------------
lldb_private::ConstString
ABICheri_mips64::GetPluginName()
{
    return GetPluginNameStatic();
}

uint32_t
ABICheri_mips64::GetPluginVersion()
{
    return 1;
}
